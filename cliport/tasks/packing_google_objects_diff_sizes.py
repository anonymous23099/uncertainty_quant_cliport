...
class PackingSeenGoogleObjectsSeqDiffSizes(Task):
    ...
    def reset(self, env):
        ...
        # # Add Google Scanned Objects to scene at smaller size.
        # # scaling_factor = 0.25
        # object_points = {}
        # object_ids = []
        # bboxes = np.array(bboxes)
        ...
        # adding blocks with smaller sizes for distraction
        ...
        block_urdf = 'stacking/small_blocks.urdf' #'stacking/small.urdf'
        for i in range(6):
...
class PackingUnseenGoogleObjectsSeq(PackingSeenGoogleObjectsSeqDiffSizes):
...
class PackingSeenGoogleObjectsGroupDiffSizes(PackingSeenGoogleObjectsSeqDiffSizes):
...
class PackingUnseenGoogleObjectsGroup(PackingSeenGoogleObjectsGroupDiffSizes):
